...
function minsAgo(n) {
  var d = new Date(Date.now() - n * 60000)
...
const data = {
  ...
  alerts: [
    { id: 1, rule_id: 1, ci_id: 1, level: 'critical', title: 'CPU使用率超过90%', resource: 'server-001 (华北区域)', metric: 'CPU使用率', current_value: '95%', threshold: '> 90%', duration: '5分钟', display_duration: '5分钟', duration_minutes: 5, trigger_time: '2026-06-17 10:32:00+08', recovery_time: null, status: 'firing', category: '阈值类', incident_id: 'INC-2026-0720', suggestion: '1. 检查是否有异常进程占用CPU\n2. 查看应用日志定位慢查询\n3. 必要时重启相关服务' },
    { id: 2, rule_id: 3, ci_id: 4, level: 'critical', title: '磁盘空间不足', resource: 'db-primary (华东区域)', metric: '磁盘使用率', current_value: '92%', threshold: '> 90%', duration: '12分钟', display_duration: '12分钟', duration_minutes: 12, trigger_time: '2026-06-17 10:28:00+08', recovery_time: null, status: 'firing', category: '容量类', incident_id: 'INC-2026-0718', suggestion: '1. 清理过期日志文件\n2. 检查大表并归档历史数据\n3. 扩容磁盘或迁移数据' },
    { id: 3, rule_id: 5, ci_id: 5, level: 'critical', title: '数据库主从延迟', resource: 'db-replica-02 (华东区域)', metric: '复制延迟', current_value: '35s', threshold: '> 10s', duration: '37分钟', display_duration: '37分钟', duration_minutes: 37, trigger_time: '2026-06-17 09:55:00+08', recovery_time: null, status: 'firing', category: '服务类', incident_id: 'INC-2026-0720', suggestion: '1. 检查主库写入压力\n2. 检查从库IO/SQL线程状态\n3. 确认网络带宽是否充足' },
    { id: 4, rule_id: 2, ci_id: 2, level: 'warning', title: '内存使用率偏高', resource: 'app-server-03 (华南区域)', metric: '内存使用率', current_value: '82%', threshold: '> 80%', duration: '20分钟', display_duration: '20分钟', duration_minutes: 20, trigger_time: '2026-06-17 10:15:00+08', recovery_time: null, status: 'firing', category: '阈值类', incident_id: 'INC-2026-0720', suggestion: '1. 检查JVM堆内存使用情况\n2. 分析是否有内存泄漏\n3. 调整容器内存限制' },
    { id: 5, rule_id: 4, ci_id: 10, level: 'warning', title: '响应时间超时', resource: 'api-gateway (华北区域)', metric: '响应时间', current_value: '2500ms', threshold: '> 2000ms', duration: '1小时', display_duration: '1小时', duration_minutes: 60, trigger_time: '2026-06-17 09:45:00+08', recovery_time: null, status: 'firing', category: '阈值类', incident_id: 'INC-2026-0720', suggestion: '1. 检查下游服务响应时间\n2. 分析慢请求链路\n3. 考虑增加限流或降级策略' },
    { id: 6, rule_id: 4, ci_id: 9, level: 'warning', title: 'HTTP 5xx错误率上升', resource: 'nginx-ingress (华北区域)', metric: '5xx错误率', current_value: '3.2%', threshold: '> 1%', duration: '1.5小时', display_duration: '1.5小时', duration_minutes: 90, trigger_time: '2026-06-17 09:30:00+08', recovery_time: null, status: 'suppressed', category: '服务类', incident_id: 'INC-2026-0722', suggestion: '1. 检查后端服务健康状态\n2. 查看nginx错误日志\n3. 回滚最近变更' },
    { id: 7, rule_id: 5, ci_id: 6, level: 'info', title: '连接数接近上限', resource: 'redis-cluster (华东区域)', metric: '连接数', current_value: '85%', threshold: '> 80%', duration: '2小时', display_duration: '2小时', duration_minutes: 120, trigger_time: '2026-06-17 09:20:00+08', recovery_time: null, status: 'firing', category: '容量类', incident_id: 'INC-2026-0718', suggestion: '1. 检查连接池配置\n2. 排查是否有连接泄漏\n3. 考虑扩容Redis节点' },
    { id: 8, rule_id: 7, ci_id: null, level: 'info', title: '证书即将过期', resource: 'cdn-domain.example.com', metric: '证书剩余天数', current_value: '15天', threshold: '< 30天', duration: '2.5小时', display_duration: '2.5小时', duration_minutes: 150, trigger_time: '2026-06-17 08:00:00+08', recovery_time: null, status: 'firing', category: '证书类', incident_id: 'INC-2026-0723', suggestion: '1. 申请新证书\n2. 更新证书配置\n3. 验证HTTPS访问正常' },
    { id: 9, rule_id: 6, ci_id: 11, level: 'critical', title: 'K8s Pod频繁重启', resource: 'payment-service (prod)', metric: 'Pod重启率', current_value: '5次/小时', threshold: '> 3次/小时', duration: '已恢复', display_duration: '已恢复', duration_minutes: 0, trigger_time: '2026-06-17 08:45:00+08', recovery_time: '2026-06-17 10:00:00+08', status: 'resolved', category: '服务类', incident_id: 'INC-2026-0715', suggestion: '1. 查看Pod事件和日志\n2. 检查OOMKilled情况\n3. 调整resources限制' },
    { id: 10, rule_id: null, ci_id: 7, level: 'warning', title: '消息队列积压', resource: 'kafka-consumer-group order', metric: '积压量', current_value: '50000条', threshold: '> 10000条', duration: '已恢复', display_duration: '已恢复', duration_minutes: 0, trigger_time: '2026-06-17 07:30:00+08', recovery_time: '2026-06-17 10:30:00+08', status: 'resolved', category: '容量类', incident_id: 'INC-2026-0719', suggestion: '1. 检查消费者处理逻辑\n2. 增加消费者实例数\n3. 检查生产者发送速率' },
    { id: 11, rule_id: 4, ci_id: 8, level: 'warning', title: '网络丢包率过高', resource: 'switch-01 (华北区域)', metric: '丢包率', current_value: '2.1%', threshold: '> 1%', duration: '45分钟', display_duration: '45分钟', duration_minutes: 45, trigger_time: '2026-06-17 06:30:00+08', recovery_time: null, status: 'firing', category: '网络类', incident_id: 'INC-2026-0724', suggestion: '1. 检查网络链路质量\n2. 排查交换机端口错误\n3. 联系网络运维处理' },
    { id: 12, rule_id: null, ci_id: 12, level: 'info', title: 'NTP同步偏移过大', resource: 'ntp-server', metric: '时间偏移', current_value: '850ms', threshold: '> 500ms', duration: '已恢复', display_duration: '已恢复', duration_minutes: 0, trigger_time: '2026-06-16 23:00:00+08', recovery_time: '2026-06-17 01:00:00+08', status: 'resolved', category: '阈值类', incident_id: null, suggestion: '1. 检查NTP服务状态\n2. 确认时间源可达\n3. 手动同步时间' },
    { id: 13, rule_id: 8, ci_id: 1, level: 'critical', title: '物理机CPU温度过高', resource: 'server-003 (华北区域)', metric: 'CPU温度', current_value: '92°C', threshold: '> 85°C', duration: '10分钟', display_duration: '10分钟', duration_minutes: 10, trigger_time: '2026-06-17 11:00:00+08', recovery_time: null, status: 'firing', category: '硬件类', incident_id: 'INC-2026-0725', suggestion: '1. 检查服务器散热风扇\n2. 清理灰尘\n3. 考虑迁移至备用节点' },
    { id: 14, rule_id: 9, ci_id: 8, level: 'critical', title: '交换机端口Down', resource: 'switch-02 (华东区域)', metric: '端口状态', current_value: 'Down', threshold: 'Up', duration: '30分钟', display_duration: '30分钟', duration_minutes: 30, trigger_time: '2026-06-17 10:30:00+08', recovery_time: null, status: 'firing', category: '硬件类', incident_id: 'INC-2026-0725', suggestion: '1. 检查物理连线\n2. 排查端口故障\n3. 切换备用链路' },
    { id: 15, rule_id: 10, ci_id: null, level: 'warning', title: '安全组规则对外开放0.0.0.0/0', resource: 'sg-001 (华北区域)', metric: '安全组规则', current_value: '0.0.0.0/0', threshold: 'N/A', duration: '持续', display_duration: '持续', duration_minutes: 0, trigger_time: '2026-06-17 08:00:00+08', recovery_time: null, status: 'firing', category: '配置类', incident_id: 'INC-2026-0726', suggestion: '1. 收紧安全组规则\n2. 限制源IP范围\n3. 审批记录归档' },
    { id: 16, rule_id: 4, ci_id: 8, level: 'critical', title: 'BGP邻居断开', resource: 'router-01 (华北区域)', metric: 'BGP状态', current_value: 'Down', threshold: 'Established', duration: '15分钟', display_duration: '15分钟', duration_minutes: 15, trigger_time: '2026-06-17 10:45:00+08', recovery_time: null, status: 'firing', category: '网络类', incident_id: 'INC-2026-0724', suggestion: '1. 检查BGP配置\n2. 排查链路故障\n3. 联系运营商处理' },
    // ---- AI 聚合测试用：重复告警（CPU使用率超过90%，同 title+metric） ----
    { id: 17, rule_id: 1, ci_id: 1, level: 'critical', title: 'CPU使用率超过90%', resource: 'server-005 (华南区域)', metric: 'CPU使用率', current_value: '93%', threshold: '> 90%', duration: '8分钟', display_duration: '8分钟', duration_minutes: 8, trigger_time: minsAgo(12), recovery_time: null, status: 'firing', category: '阈值类', incident_id: null, suggestion: '1. 检查异常进程\n2. 查看应用日志\n3. 必要时重启服务' },
    { id: 18, rule_id: 1, ci_id: 2, level: 'critical', title: 'CPU使用率超过90%', resource: 'server-008 (华北区域)', metric: 'CPU使用率', current_value: '91%', threshold: '> 90%', duration: '15分钟', display_duration: '15分钟', duration_minutes: 15, trigger_time: minsAgo(25), recovery_time: null, status: 'firing', category: '阈值类', incident_id: null, suggestion: '1. 检查异常进程\n2. 查看应用日志\n3. 必要时重启服务' },
    { id: 19, rule_id: 1, ci_id: 3, level: 'warning', title: 'CPU使用率超过90%', resource: 'server-012 (华东区域)', metric: 'CPU使用率', current_value: '90%', threshold: '> 90%', duration: '3分钟', display_duration: '3分钟', duration_minutes: 3, trigger_time: minsAgo(3), recovery_time: null, status: 'firing', category: '阈值类', incident_id: null, suggestion: '1. 检查异常进程\n2. 查看应用日志\n3. 必要时重启服务' },
    // ---- AI 聚合测试用：重复告警（磁盘空间不足，同 title+metric） ----
    { id: 20, rule_id: 3, ci_id: 4, level: 'critical', title: '磁盘空间不足', resource: 'db-replica-01 (华东区域)', metric: '磁盘使用率', current_value: '94%', threshold: '> 90%', duration: '20分钟', display_duration: '20分钟', duration_minutes: 20, trigger_time: minsAgo(8), recovery_time: null, status: 'firing', category: '容量类', incident_id: null, suggestion: '1. 清理日志\n2. 归档数据\n3. 扩容磁盘' },
    { id: 21, rule_id: 3, ci_id: 5, level: 'warning', title: '磁盘空间不足', resource: 'app-server-06 (华北区域)', metric: '磁盘使用率', current_value: '91%', threshold: '> 90%', duration: '35分钟', display_duration: '35分钟', duration_minutes: 35, trigger_time: minsAgo(40), recovery_time: null, status: 'firing', category: '容量类', incident_id: null, suggestion: '1. 清理日志\n2. 归档数据\n3. 扩容磁盘' },
    { id: 22, rule_id: 3, ci_id: 6, level: 'info', title: '磁盘空间不足', resource: 'redis-cluster-02 (华南区域)', metric: '磁盘使用率', current_value: '90%', threshold: '> 90%', duration: '5分钟', display_duration: '5分钟', duration_minutes: 5, trigger_time: minsAgo(5), recovery_time: null, status: 'firing', category: '容量类', incident_id: null, suggestion: '1. 清理日志\n2. 归档数据\n3. 扩容磁盘' },
    // ---- 新增7条告警（对应INC-2026-0727~0733） ----
    { id: 23, rule_id: 5, ci_id: 6, level: 'warning', title: 'Redis连接池接近上限', resource: 'redis-cluster (华东区域)', metric: '连接数', current_value: '85%', threshold: '> 80%', duration: '30分钟', display_duration: '30分钟', duration_minutes: 30, trigger_time: minsAgo(55), recovery_time: null, status: 'firing', category: '容量类', incident_id: 'INC-2026-0727', suggestion: '1. 排查连接泄漏\n2. 调整连接池上限' },
    { id: 24, rule_id: 4, ci_id: 9, level: 'critical', title: 'HTTP 5xx错误率飙升', resource: 'nginx-ingress (华北区域)', metric: '5xx错误率', current_value: '8.5%', threshold: '> 1%', duration: '45分钟', display_duration: '45分钟', duration_minutes: 45, trigger_time: minsAgo(35), recovery_time: null, status: 'firing', category: '服务类', incident_id: 'INC-2026-0728', suggestion: '1. 检查后端服务\n2. 查看nginx日志\n3. 回滚最近变更' },
    { id: 25, rule_id: 6, ci_id: 11, level: 'critical', title: 'K8s节点NotReady', resource: 'prod-k8s-node-03', metric: '节点状态', current_value: 'NotReady', threshold: 'Ready', duration: '30分钟', display_duration: '30分钟', duration_minutes: 30, trigger_time: minsAgo(25), recovery_time: null, status: 'firing', category: '硬件类', incident_id: 'INC-2026-0729', suggestion: '1. 检查节点日志\n2. 重启kubelet\n3. 检查硬件' },
    { id: 26, rule_id: 5, ci_id: 5, level: 'warning', title: 'MySQL主从延迟过高', resource: 'db-replica-02 (华东区域)', metric: '复制延迟', current_value: '45s', threshold: '> 10s', duration: '1小时', display_duration: '1小时', duration_minutes: 60, trigger_time: minsAgo(90), recovery_time: minsAgo(35), status: 'resolved', category: '服务类', incident_id: 'INC-2026-0730', suggestion: '1. 检查主库写入量\n2. 优化并行复制' },
    { id: 27, rule_id: null, ci_id: 7, level: 'warning', title: 'MQ消费组消息积压', resource: 'kafka-consumer-group order', metric: '积压量', current_value: '80000条', threshold: '> 10000条', duration: '2.5小时', display_duration: '2.5小时', duration_minutes: 150, trigger_time: minsAgo(180), recovery_time: null, status: 'firing', category: '容量类', incident_id: 'INC-2026-0731', suggestion: '1. 检查消费者逻辑\n2. 扩容消费者实例' },
    { id: 28, rule_id: null, ci_id: 10, level: 'info', title: '弹性IP即将释放', resource: 'eip-001', metric: 'EIP状态', current_value: '欠费', threshold: '正常', duration: '20小时', display_duration: '20小时', duration_minutes: 1200, trigger_time: minsAgo(1200), recovery_time: minsAgo(5), status: 'resolved', category: '配置类', incident_id: 'INC-2026-0732', suggestion: '1. 续费EIP\n2. 确认公网入口' },
    { id: 29, rule_id: 4, ci_id: 8, level: 'critical', title: 'DNS解析延迟飙升', resource: 'dns-resolver (华北区域)', metric: 'DNS解析延迟', current_value: '5000ms', threshold: '> 100ms', duration: '25分钟', display_duration: '25分钟', duration_minutes: 25, trigger_time: minsAgo(10), recovery_time: null, status: 'firing', category: '网络类', incident_id: 'INC-2026-0733', suggestion: '1. 检查DNS服务器\n2. 切换备用DNS\n3. 联系运营商' },
  ],
