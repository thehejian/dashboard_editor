...
const data = {
  ...
  alerts: [
    { id: 1, rule_id: 1, ci_id: 1, level: 'critical', title: 'CPU使用率超过90%', resource: 'server-001 (华北区域)', metric: 'CPU使用率', current_value: '95%', threshold: '> 90%', duration: '5分钟', display_duration: '5分钟', duration_minutes: 5, trigger_time: '2026-06-17 10:32:00+08', recovery_time: null, status: 'firing', suggestion: '1. 检查是否有异常进程占用CPU\n2. 查看应用日志定位慢查询\n3. 必要时重启相关服务' },
    { id: 2, rule_id: 3, ci_id: 4, level: 'critical', title: '磁盘空间不足', resource: 'db-primary (华东区域)', metric: '磁盘使用率', current_value: '92%', threshold: '> 90%', duration: '12分钟', display_duration: '12分钟', duration_minutes: 12, trigger_time: '2026-06-17 10:28:00+08', recovery_time: null, status: 'firing', suggestion: '1. 清理过期日志文件\n2. 检查大表并归档历史数据\n3. 扩容磁盘或迁移数据' },
    { id: 3, rule_id: 5, ci_id: 5, level: 'critical', title: '数据库主从延迟', resource: 'db-replica-02 (华东区域)', metric: '复制延迟', current_value: '35s', threshold: '> 10s', duration: '37分钟', display_duration: '37分钟', duration_minutes: 37, trigger_time: '2026-06-17 09:55:00+08', recovery_time: null, status: 'firing', suggestion: '1. 检查主库写入压力\n2. 检查从库IO/SQL线程状态\n3. 确认网络带宽是否充足' },
    { id: 4, rule_id: 2, ci_id: 2, level: 'warning', title: '内存使用率偏高', resource: 'app-server-03 (华南区域)', metric: '内存使用率', current_value: '82%', threshold: '> 80%', duration: '20分钟', display_duration: '20分钟', duration_minutes: 20, trigger_time: '2026-06-17 10:15:00+08', recovery_time: null, status: 'firing', suggestion: '1. 检查JVM堆内存使用情况\n2. 分析是否有内存泄漏\n3. 调整容器内存限制' },
    { id: 5, rule_id: 4, ci_id: 10, level: 'warning', title: '响应时间超时', resource: 'api-gateway (华北区域)', metric: '响应时间', current_value: '2500ms', threshold: '> 2000ms', duration: '1小时', display_duration: '1小时', duration_minutes: 60, trigger_time: '2026-06-17 09:45:00+08', recovery_time: null, status: 'firing', suggestion: '1. 检查下游服务响应时间\n2. 分析慢请求链路\n3. 考虑增加限流或降级策略' },
    { id: 6, rule_id: 4, ci_id: 9, level: 'warning', title: 'HTTP 5xx错误率上升', resource: 'nginx-ingress (华北区域)', metric: '5xx错误率', current_value: '3.2%', threshold: '> 1%', duration: '1.5小时', display_duration: '1.5小时', duration_minutes: 90, trigger_time: '2026-06-17 09:30:00+08', recovery_time: null, status: 'suppressed', suggestion: '1. 检查后端服务健康状态\n2. 查看nginx错误日志\n3. 回滚最近变更' },
    { id: 7, rule_id: 5, ci_id: 6, level: 'info', title: '连接数接近上限', resource: 'redis-cluster (华东区域)', metric: '连接数', current_value: '85%', threshold: '> 80%', duration: '2小时', display_duration: '2小时', duration_minutes: 120, trigger_time: '2026-06-17 09:20:00+08', recovery_time: null, status: 'firing', suggestion: '1. 检查连接池配置\n2. 排查是否有连接泄漏\n3. 考虑扩容Redis节点' },
    { id: 8, rule_id: 7, ci_id: null, level: 'info', title: '证书即将过期', resource: 'cdn-domain.example.com', metric: '证书剩余天数', current_value: '15天', threshold: '< 30天', duration: '2.5小时', display_duration: '2.5小时', duration_minutes: 150, trigger_time: '2026-06-17 08:00:00+08', recovery_time: null, status: 'firing', suggestion: '1. 申请新证书\n2. 更新证书配置\n3. 验证HTTPS访问正常' },
    { id: 9, rule_id: 6, ci_id: 11, level: 'critical', title: 'K8s Pod频繁重启', resource: 'payment-service (prod)', metric: 'Pod重启率', current_value: '5次/小时', threshold: '> 3次/小时', duration: '已恢复', display_duration: '已恢复', duration_minutes: 0, trigger_time: '2026-06-17 08:45:00+08', recovery_time: '2026-06-17 10:00:00+08', status: 'resolved', suggestion: '1. 查看Pod事件和日志\n2. 检查OOMKilled情况\n3. 调整resources限制' },
    { id: 10, rule_id: null, ci_id: 7, level: 'warning', title: '消息队列积压', resource: 'kafka-consumer-group order', metric: '积压量', current_value: '50000条', threshold: '> 10000条', duration: '已恢复', display_duration: '已恢复', duration_minutes: 0, trigger_time: '2026-06-17 07:30:00+08', recovery_time: '2026-06-17 10:30:00+08', status: 'resolved', suggestion: '1. 检查消费者处理逻辑\n2. 增加消费者实例数\n3. 检查生产者发送速率' },
    { id: 11, rule_id: 4, ci_id: 8, level: 'warning', title: '网络丢包率过高', resource: 'switch-01 (华北区域)', metric: '丢包率', current_value: '2.1%', threshold: '> 1%', duration: '45分钟', display_duration: '45分钟', duration_minutes: 45, trigger_time: '2026-06-17 06:30:00+08', recovery_time: null, status: 'firing', suggestion: '1. 检查网络链路质量\n2. 排查交换机端口错误\n3. 联系网络运维处理' },
    { id: 12, rule_id: null, ci_id: 12, level: 'info', title: 'NTP同步偏移过大', resource: 'ntp-server', metric: '时间偏移', current_value: '850ms', threshold: '> 500ms', duration: '已恢复', display_duration: '已恢复', duration_minutes: 0, trigger_time: '2026-06-16 23:00:00+08', recovery_time: '2026-06-17 01:00:00+08', status: 'resolved', suggestion: '1. 检查NTP服务状态\n2. 确认时间源可达\n3. 手动同步时间' },
  ],
...
const SCHEMA = {
  ...
  alerts: [
    ...
    ['recovery_time', 'timestamp with time zone', true], ['status', 'character varying', true], ['suggestion', 'text', true],
