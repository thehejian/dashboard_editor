...
const data = {
  ...
  alerts: [
    ...
    { id: 2, rule_id: 3, ci_id: 4, level: 'critical', title: '磁盘空间不足', resource: 'db-primary (华东区域)', metric: '磁盘使用率', current_value: '92%', threshold: '> 90%', duration: '12分钟', display_duration: '12分钟', duration_minutes: 12, trigger_time: '2026-06-17 10:28:00+08', recovery_time: null, status: 'firing', category: '容量类', incident_id: null, suggestion: '1. 清理过期日志文件\n2. 检查大表并归档历史数据\n3. 扩容磁盘或迁移数据' },
    ...
    { id: 8, rule_id: 7, ci_id: null, level: 'info', title: '证书即将过期', resource: 'cdn-domain.example.com', metric: '证书剩余天数', current_value: '15天', threshold: '< 30天', duration: '2.5小时', display_duration: '2.5小时', duration_minutes: 150, trigger_time: '2026-06-17 08:00:00+08', recovery_time: null, status: 'firing', category: '证书类', incident_id: null, suggestion: '1. 申请新证书\n2. 更新证书配置\n3. 验证HTTPS访问正常' },
    ...
    { id: 11, rule_id: 4, ci_id: 8, level: 'warning', title: '网络丢包率过高', resource: 'switch-01 (华北区域)', metric: '丢包率', current_value: '2.1%', threshold: '> 1%', duration: '45分钟', display_duration: '45分钟', duration_minutes: 45, trigger_time: '2026-06-17 06:30:00+08', recovery_time: null, status: 'firing', category: '网络类', incident_id: null, suggestion: '1. 检查网络链路质量\n2. 排查交换机端口错误\n3. 联系网络运维处理' },
