...
const MOCK_INCIDENTS = [
  ...
  },
  {
    id: 'INC-2026-0721',
    title: '推荐服务模型推理延迟升高',
    description: '推荐服务模型推理耗时波动，疑似 GPU 资源抢占与热点请求堆积引起。',
    status: 'investigating',
    severity: 'P3',
    appName: '推荐服务',
    appNodeId: 'prod-order-02',
    service: 'recommend-service',
    startTime: '2026-07-21 09:40:00',
    endTime: null,
    duration: '15min',
    metrics: {
      p99: { current: 950, baseline: 120, unit: 'ms', multiplier: '8x 突增' },
      failureRate: { current: 12.8, unit: '%', label: '推理超时' },
      affectedUsers: { current: 320, label: '受影响用户' },
  ...
  },
  {
    ...
    description: '部分节点日志采集 Agent 异常停止，导致可观测性数据缺失影响告警判断。',
    status: 'investigating',
    severity: 'P3',
    appName: '监控服务',
    appNodeId: 'prod-pay-02',
    service: 'log-agent',
    startTime: '2026-07-17 11:30:00',
    endTime: null,
    duration: '10min',
    metrics: {
      p99: { current: 0, baseline: 0, unit: 'ms', multiplier: '' },
      failureRate: { current: 0, unit: '%', label: '采集链路中断' },
  ...
  {
    id: 'INC-2026-0727',
    title: 'Redis集群连接池接近上限',
    description: 'redis-cluster华东区域连接数达85%，接近最大连接数上限，需扩容或优化连接池。',
    status: 'investigating',
    severity: 'P2',
    appName: '缓存服务',
    appNodeId: 'redis-cluster-huadong',
    service: 'redis-cluster',
    startTime: '2026-06-17 09:20:00',
    endTime: null,
    duration: '1h10m',
    metrics: {
      p99: { current: 12, baseline: 5, unit: 'ms', multiplier: '2.4x' },
      failureRate: { current: 0, unit: '%', label: '连接拒绝风险' },
      affectedUsers: { current: 0, label: '受影响用户' },
      affectedSessions: { current: 0, label: '受影响会话' },
    },
    healingProgress: 0,
    relatedAlertIds: [],
    topologyNodeIds: ['redis-cluster-huadong'],
    impactScope: '连接数持续上升，预计30min内耗尽',
    assignee: '李工',
    sla_deadline: '2026-06-17 10:30:00',
    sla_status: 'pending',
    checklist: [
      { step: 1, title: '排查连接泄漏', handler: '李工', status: 'running', started_at: '09:25', finished_at: null },
      { step: 2, title: '调整连接池上限', handler: '李工', status: 'pending', started_at: null, finished_at: null },
    ],
    tracking_timeline: [
      { time: '09:20', phase: '检测告警', actor: '系统', action: 'Redis连接数85%' },
      { time: '09:22', phase: 'AI诊断', actor: 'AI系统', action: '疑似连接泄漏，建议排查' },
    ],
    tracking_comments: [],
    timeline: [
      { time: '09:20', event: '告警触发', type: 'alert', detail: 'Redis连接数85%超过阈值80%' },
    ],
  },
  {
    id: 'INC-2026-0728',
    title: 'Nginx入口5xx错误率飙升',
    description: 'nginx-ingress华北区域5xx错误率从1%飙升至8.5%，影响所有入站流量。',
    status: 'investigating',
    severity: 'P1',
    appName: '网关服务',
    appNodeId: 'nginx-ingress-huabei',
    service: 'nginx-ingress',
    startTime: '2026-06-17 09:30:00',
    endTime: null,
    duration: '1h',
    metrics: {
      p99: { current: 5200, baseline: 200, unit: 'ms', multiplier: '26x' },
      failureRate: { current: 8.5, unit: '%', label: 'HTTP 5xx' },
      affectedUsers: { current: 3200, label: '受影响用户' },
      affectedSessions: { current: 3500, label: '受影响会话' },
    },
    healingProgress: 20,
    relatedAlertIds: [],
    topologyNodeIds: ['nginx-ingress-huabei', 'prod-order-01'],
    impactScope: '影响所有入站流量，下游订单服务不可达',
    assignee: 'AI系统',
    sla_deadline: '2026-06-17 10:00:00',
    sla_status: 'overdue',
    checklist: [
      { step: 1, title: '定位5xx来源', handler: 'AI系统', status: 'done', started_at: '09:31', finished_at: '09:35' },
      { step: 2, title: '回滚最近变更', handler: 'AI系统', status: 'running', started_at: '09:35', finished_at: null },
    ],
    tracking_timeline: [
      { time: '09:30', phase: '检测告警', actor: '系统', action: '5xx错误率8.5%' },
      { time: '09:31', phase: 'AI诊断', actor: 'AI系统', action: '定位到upstream超时' },
      { time: '09:35', phase: '自动修复', actor: 'AI系统', action: '执行回滚操作' },
    ],
    tracking_comments: [],
    timeline: [
      { time: '09:30', event: '告警触发', type: 'alert', detail: 'HTTP 5xx错误率8.5%超过阈值1%' },
      { time: '09:35', event: 'AI检测', type: 'detection', detail: 'upstream连接超时' },
    ],
  },
  {
    id: 'INC-2026-0729',
    title: 'K8s工作节点NotReady',
    description: 'prod-k8s-node-03状态变为NotReady，影响12个Pod调度。',
    status: 'investigating',
    severity: 'P1',
    appName: '容器平台',
    appNodeId: 'prod-k8s-node-03',
    service: 'k8s-node',
    ...
    metrics: {
      p99: { current: 0, baseline: 0, unit: 'ms', multiplier: '' },
      failureRate: { current: 100, unit: '%', label: '节点不可用' },
      affectedUsers: { current: 0, label: '受影响用户' },
      affectedSessions: { current: 0, label: '受影响会话' },
    },
    healingProgress: 10,
    relatedAlertIds: [],
    topologyNodeIds: ['prod-k8s-node-03'],
    impactScope: '12个Pod待调度，需人工现场检查',
    assignee: '张工',
    sla_deadline: '2026-06-17 11:00:00',
    sla_status: 'pending',
    checklist: [
      { step: 1, title: '检查节点系统日志', handler: '张工', status: 'running', started_at: '10:05', finished_at: null },
    ],
    tracking_timeline: [
      { time: '10:00', phase: '检测告警', actor: '系统', action: '节点NotReady' },
      { time: '10:02', phase: 'AI诊断', actor: 'AI系统', action: '疑似kubelet进程异常' },
    ],
    tracking_comments: [],
    timeline: [
      { time: '10:00', event: '告警触发', type: 'alert', detail: 'K8s节点NotReady' },
    ],
  },
  {
    id: 'INC-2026-0730',
    title: 'MySQL主从复制延迟过高',
    description: 'db-replica-02主从延迟达45s，远超10s阈值，影响读写分离。',
    status: 'resolved',
    severity: 'P2',
    appName: '数据库服务',
    appNodeId: 'db-replica-02',
    service: 'mysql',
    ...
    healingProgress: 100,
    relatedAlertIds: [],
    topologyNodeIds: ['db-master', 'db-replica-02'],
    impactScope: '读写分离延迟，已恢复正常',
    assignee: 'AI系统',
    sla_deadline: '2026-06-17 09:00:00',
    sla_status: 'resolved',
    checklist: [
      { step: 1, title: '分析主库写入量', handler: 'AI系统', status: 'done', started_at: '08:31', finished_at: '08:35' },
      { step: 2, title: '优化从库并行复制', handler: 'AI系统', status: 'done', started_at: '08:35', finished_at: '09:40' },
    ],
    tracking_timeline: [
      { time: '08:30', phase: '检测告警', actor: '系统', action: '主从延迟45s' },
      { time: '08:35', phase: 'AI修复', actor: 'AI系统', action: '调整并行复制参数' },
      { time: '09:45', phase: '恢复确认', actor: '系统', action: '延迟降至0.5s' },
    ],
    tracking_comments: [],
    timeline: [
      { time: '08:30', event: '告警触发', type: 'alert', detail: '主从延迟45s超过阈值10s' },
      { time: '09:45', event: '告警恢复', type: 'resolved', detail: '延迟降至0.5s' },
    ],
  },
  {
    id: 'INC-2026-0731',
    title: 'MQ消费组消息积压告警',
    description: 'kafka-consumer-group order积压量达80000条，消费速度跟不上生产速度。',
    status: 'investigating',
    severity: 'P2',
    appName: '消息服务',
    appNodeId: 'kafka-consumer-order',
    service: 'kafka',
    ...
    healingProgress: 0,
    relatedAlertIds: [],
    topologyNodeIds: ['kafka-broker', 'kafka-consumer-order'],
    impactScope: '订单处理延迟，影响下游支付回调',
    assignee: '王工',
    sla_deadline: '2026-06-17 08:30:00',
    sla_status: 'overdue',
    checklist: [
      { step: 1, title: '检查消费者实例数', handler: '王工', status: 'done', started_at: '07:35', finished_at: '07:40' },
      { step: 2, title: '扩容消费者', handler: '王工', status: 'running', started_at: '07:40', finished_at: null },
    ],
    tracking_timeline: [
      { time: '07:30', phase: '检测告警', actor: '系统', action: '积压80000条' },
      { time: '07:32', phase: 'AI诊断', actor: 'AI系统', action: '消费者处理能力不足' },
    ],
    tracking_comments: [],
    timeline: [
      { time: '07:30', event: '告警触发', type: 'alert', detail: 'MQ积压80000条超过阈值10000条' },
    ],
  },
  {
    id: 'INC-2026-0732',
    title: '弹性IP地址即将释放',
    description: 'eip-001弹性IP因欠费即将在24h后释放，影响公网入口。',
    status: 'resolved',
    severity: 'P3',
    appName: '网络服务',
    appNodeId: 'eip-001',
    service: 'eip',
    startTime: '2026-06-16 12:00:00',
    ...
    healingProgress: 100,
    relatedAlertIds: [],
    topologyNodeIds: ['eip-001'],
    impactScope: '已续费，公网入口恢复正常',
    assignee: 'AI系统',
    sla_deadline: '2026-06-17 12:00:00',
    sla_status: 'resolved',
    checklist: [
      { step: 1, title: '自动续费', handler: 'AI系统', status: 'done', started_at: '08:00', finished_at: '08:00' },
    ],
    tracking_timeline: [
      { time: '12:00', phase: '检测告警', actor: '系统', action: 'EIP欠费即将释放' },
      { time: '08:00', phase: '自动修复', actor: 'AI系统', action: '自动续费完成' },
    ],
    tracking_comments: [],
    timeline: [
      { time: '12:00', event: '告警触发', type: 'alert', detail: '弹性IP欠费即将释放' },
      { time: '08:00', event: '告警恢复', type: 'resolved', detail: '自动续费完成' },
    ],
  },
  {
    id: 'INC-2026-0733',
    title: 'DNS解析异常导致服务不可达',
    description: '华北区域DNS解析延迟飙升至5s，多个服务域名解析失败。',
    status: 'investigating',
    severity: 'P1',
    appName: '基础服务',
    appNodeId: 'dns-resolver-huabei',
    service: 'dns',
    startTime: '2026-06-17 10:15:00',
    endTime: null,
    duration: '25m',
    metrics: {
      p99: { current: 5000, baseline: 10, unit: 'ms', multiplier: '500x' },
      failureRate: { current: 45, unit: '%', label: 'DNS解析失败' },
      affectedUsers: { current: 5000, label: '受影响用户' },
      affectedSessions: { current: 5200, label: '受影响会话' },
    },
    healingProgress: 0,
    relatedAlertIds: [],
    topologyNodeIds: ['dns-resolver-huabei'],
    impactScope: '华北区域所有依赖DNS的服务受影响',
    assignee: '刘工',
    sla_deadline: '2026-06-17 10:30:00',
    sla_status: 'overdue',
    checklist: [
      { step: 1, title: '检查DNS服务器状态', handler: '刘工', status: 'running', started_at: '10:20', finished_at: null },
    ],
    tracking_timeline: [
      { time: '10:15', phase: '检测告警', actor: '系统', action: 'DNS解析延迟5s' },
      { time: '10:17', phase: 'AI诊断', actor: 'AI系统', action: '疑似DNS服务器过载' },
    ],
    tracking_comments: [],
    timeline: [
      { time: '10:15', event: '告警触发', type: 'alert', detail: 'DNS解析延迟5s超过阈值100ms' },
    ],
  },
]
...
const MOCK_RCA_REPORTS = [
  {
    ...
    evidence: [
      { key: '连接数', detail: 'mysql-master 连接数↑120% (1024/1024 满)', node: 'mysql-master', nodeLabel: 'MySQL主库', value: 1024, baseline: 500, unit: '连接', level: 'critical', time: '08:58:10',
        aiScore: { zScore: 3.1, ewmaSlope: 2.5, deviation: 105, historicalSimilarity: 0.62, confidence: '中', duration: '10分钟' } },
      { key: 'P99', detail: '结账接口 P99 由 20ms 飙升至 3500ms', node: 'prod-order-01', nodeLabel: '订单服务-01', value: 3500, baseline: 20, unit: 'ms', level: 'critical', time: '08:58:01',
        aiScore: { zScore: 4.2, ewmaSlope: 3.2, deviation: 115, historicalSimilarity: 0.87, confidence: '极高', duration: '13分钟' } },
      { key: '错误率', detail: '灰度节点错误率 88% (大量 504)', node: 'lb-api', nodeLabel: 'API Gateway', value: 88, baseline: 0.1, unit: '%', level: 'warning', time: '08:58:05',
        aiScore: { zScore: 4.5, ewmaSlope: 0.8, deviation: 2200, historicalSimilarity: 0.6, confidence: '中', duration: '8分钟' } },
      { key: '缓存命中率', detail: '缓存命中率从 95% 骤降至 45%', node: 'redis-cache', nodeLabel: 'Redis Cluster', value: 45, baseline: 95, unit: '%', level: 'warning', time: '08:57:50',
        aiScore: { zScore: 2.5, ewmaSlope: -1.8, deviation: -24.2, historicalSimilarity: 0.65, confidence: '中', duration: '12分钟' } },
    ],
  ...
  },
  {
    ...
    evidence: [
      { key: '缓存命中率', detail: '命中率由 95% 骤降至 45%', node: 'redis-cache', nodeLabel: 'Redis Cluster', value: 45, baseline: 95, unit: '%', level: 'warning', time: '10:16:00',
        aiScore: { zScore: 3.8, ewmaSlope: -2.5, deviation: -52, historicalSimilarity: 0.7, confidence: '高', duration: '8分钟' } },
      { key: '连接池', detail: '数据库连接池耗尽 (active=50)', node: 'mysql-master', nodeLabel: 'MySQL主库', value: 50, baseline: 20, unit: 'active', level: 'critical', time: '10:17:00',
        aiScore: { zScore: 3.5, ewmaSlope: 2.0, deviation: 150, historicalSimilarity: 0.65, confidence: '高', duration: '6分钟' } },
      { key: '登录超时', detail: '登录接口 P99 2800ms', node: 'prod-user-01', nodeLabel: '用户服务-01', value: 2800, baseline: 40, unit: 'ms', level: 'warning', time: '10:17:30',
        aiScore: { zScore: 3.2, ewmaSlope: 2.8, deviation: 70, historicalSimilarity: 0.58, confidence: '中', duration: '5分钟' } },
    ],
  ...
  },
  {
    ...
    evidence: [
      { key: '队列深度', detail: 'MQ 队列堆积 5200 条', node: 'mq-order', nodeLabel: 'RocketMQ', value: 5200, baseline: 500, unit: '条', level: 'critical', time: '14:32:00',
        aiScore: { zScore: 4.0, ewmaSlope: 3.5, deviation: 940, historicalSimilarity: 0.5, confidence: '高', duration: '15分钟' } },
      { key: '消费延迟', detail: 'consumer lag > 30s', node: 'mq-order', nodeLabel: 'RocketMQ', value: 30, baseline: 1, unit: 's', level: 'warning', time: '14:33:00',
        aiScore: { zScore: 2.8, ewmaSlope: 1.5, deviation: 2900, historicalSimilarity: 0.45, confidence: '中', duration: '12分钟' } },
      { key: '回调失败', detail: '回调接口失败率 45.3%', node: 'prod-pay-01', nodeLabel: '支付服务-01', value: 45.3, baseline: 0.5, unit: '%', level: 'warning', time: '14:34:00',
        aiScore: { zScore: 3.6, ewmaSlope: 2.1, deviation: 8960, historicalSimilarity: 0.55, confidence: '中', duration: '10分钟' } },
    ],
