...
.chart-group-label { grid-column: 1 / -1; font-size: 13px; font-weight: 600; color: var(--text-ter); padding: 8px 0; border-bottom: 1px solid var(--border); margin-bottom: 8px; }
