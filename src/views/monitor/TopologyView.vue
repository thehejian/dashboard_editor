...
const NODE_COLOR = { spine: '#67C23A', mgmt: '#409EFF', biz: '#722ed1', tor: '#52c41a', storage: '#E6A23C', compute: '#909399', network: '#67C23A', inbound: '#1890ff' }
const NODE_SIZE = { internet: 56, border: 52, spine: 48, tor: 42, server: 40 }

const networkTopoData = {
  nodes: [
    { id: 'internet', data: { label: 'Internet / 企业专线', extra: '网络' }, iconText: '\uf0ac', style: { fill: NODE_COLOR.inbound, size: NODE_SIZE.internet } },
    { id: 'border-leaf', data: { label: 'Border Leaf', extra: '出口网关 192.168.0.1' }, iconText: '\uf6ff', style: { fill: NODE_COLOR.inbound, size: NODE_SIZE.border } },
    { id: 'mgmt-spine-east', data: { label: '管理核心Spine', extra: '192.1.0.1' }, iconText: '\uf126', style: { fill: NODE_COLOR.spine, size: NODE_SIZE.spine }, combo: 'region-east' },
    { id: 'biz-spine-east', data: { label: '业务核心Spine', extra: '192.1.0.2' }, iconText: '\uf126', style: { fill: NODE_COLOR.biz, size: NODE_SIZE.spine }, combo: 'region-east' },
    { id: 'mgmt-tor-east', data: { label: '管理TOR', extra: '192.1.0.11' }, iconText: '\uf126', style: { fill: NODE_COLOR.tor, size: NODE_SIZE.tor }, combo: 'region-east' },
    { id: 'biz-tor-east', data: { label: '业务TOR', extra: '192.1.0.12' }, iconText: '\uf126', style: { fill: NODE_COLOR.tor, size: NODE_SIZE.tor }, combo: 'region-east' },
    { id: 'storage-tor-east', data: { label: '存储TOR', extra: '192.1.0.13' }, iconText: '\uf126', style: { fill: NODE_COLOR.tor, size: NODE_SIZE.tor }, combo: 'region-east' },
    { id: 'mgmt-nodes-east', data: { label: '管理节点', extra: 'x3' }, iconText: '\uf233', style: { fill: NODE_COLOR.mgmt, size: NODE_SIZE.server }, combo: 'region-east' },
    { id: 'network-nodes-east', data: { label: '网络节点', extra: 'x2' }, iconText: '\uf233', style: { fill: NODE_COLOR.network, size: NODE_SIZE.server }, combo: 'region-east' },
    { id: 'compute-nodes-east', data: { label: '计算节点', extra: 'x2' }, iconText: '\uf2db', style: { fill: NODE_COLOR.compute, size: NODE_SIZE.server }, combo: 'region-east' },
    { id: 'storage-nodes-east', data: { label: '存储节点', extra: 'x2' }, iconText: '\uf1c0', style: { fill: NODE_COLOR.storage, size: NODE_SIZE.server }, combo: 'region-east' },
    { id: 'mgmt-spine-north', data: { label: '管理核心Spine', extra: '192.2.0.1' }, iconText: '\uf126', style: { fill: NODE_COLOR.spine, size: NODE_SIZE.spine }, combo: 'region-north' },
    { id: 'biz-spine-north', data: { label: '业务核心Spine', extra: '192.2.0.2' }, iconText: '\uf126', style: { fill: NODE_COLOR.storage, size: NODE_SIZE.spine }, combo: 'region-north' },
    { id: 'mgmt-tor-north', data: { label: '管理TOR', extra: '192.2.0.11' }, iconText: '\uf126', style: { fill: NODE_COLOR.tor, size: NODE_SIZE.tor }, combo: 'region-north' },
    { id: 'biz-tor-north', data: { label: '业务TOR', extra: '192.2.0.12' }, iconText: '\uf126', style: { fill: NODE_COLOR.tor, size: NODE_SIZE.tor }, combo: 'region-north' },
    { id: 'storage-tor-north', data: { label: '存储TOR', extra: '192.2.0.13' }, iconText: '\uf126', style: { fill: NODE_COLOR.tor, size: NODE_SIZE.tor }, combo: 'region-north' },
    { id: 'mgmt-nodes-north', data: { label: '管理节点', extra: 'x3' }, iconText: '\uf233', style: { fill: NODE_COLOR.mgmt, size: NODE_SIZE.server }, combo: 'region-north' },
    { id: 'network-nodes-north', data: { label: '网络节点', extra: 'x2' }, iconText: '\uf233', style: { fill: NODE_COLOR.network, size: NODE_SIZE.server }, combo: 'region-north' },
    { id: 'compute-nodes-north', data: { label: '计算节点', extra: 'x2' }, iconText: '\uf2db', style: { fill: NODE_COLOR.compute, size: NODE_SIZE.server }, combo: 'region-north' },
    { id: 'storage-nodes-north', data: { label: '存储节点', extra: 'x2' }, iconText: '\uf1c0', style: { fill: NODE_COLOR.storage, size: NODE_SIZE.server }, combo: 'region-north' },
  ],
  combos: [
  ...
  networkGraph = new Graph({
    ...
    node: {
      ...
      style: {
        ...
        iconFill: '#fff',
        iconFontSize: (d) => (d.style?.size || 44) >= 48 ? 22 : 18,
        badges: (d) => d.data?.extra ? [{ text: d.data.extra, placement: 'right', backgroundFill: '#f0f0f0', backgroundRadius: 4, padding: [1, 6], fontSize: 9, fill: '#666', lineWidth: 0 }] : [],
      }
    },
    edge: {
      type: 'polyline',
