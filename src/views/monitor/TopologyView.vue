...
const networkTopoData = {
  nodes: [
    { id: 'internet', data: { label: 'Internet / 企业专线\n网络' }, badgeColor: NODE_COLOR.inbound },
    { id: 'border-leaf', data: { label: 'Border Leaf\n(出口网关)\n192.168.0.1' }, badgeColor: NODE_COLOR.inbound, style: { size: [150, 56] } },
    { id: 'mgmt-spine-east', data: { label: '管理核心Spine\n192.1.0.1' }, badgeColor: NODE_COLOR.spine, combo: 'region-east' },
    { id: 'biz-spine-east', data: { label: '业务核心Spine\n192.1.0.2' }, badgeColor: NODE_COLOR.biz, combo: 'region-east' },
    { id: 'mgmt-tor-east', data: { label: '管理TOR\n192.1.0.11' }, badgeColor: NODE_COLOR.tor, combo: 'region-east' },
    { id: 'biz-tor-east', data: { label: '业务TOR\n192.1.0.12' }, badgeColor: NODE_COLOR.tor, combo: 'region-east' },
    { id: 'storage-tor-east', data: { label: '存储TOR\n192.1.0.13' }, badgeColor: NODE_COLOR.tor, combo: 'region-east' },
    { id: 'mgmt-nodes-east', data: { label: '管理节点\nx3' }, badgeColor: NODE_COLOR.mgmt, combo: 'region-east' },
    { id: 'network-nodes-east', data: { label: '网络节点\nx2' }, badgeColor: NODE_COLOR.network, combo: 'region-east' },
    { id: 'compute-nodes-east', data: { label: '计算节点\nx2' }, badgeColor: NODE_COLOR.compute, combo: 'region-east' },
    { id: 'storage-nodes-east', data: { label: '存储节点\nx2' }, badgeColor: NODE_COLOR.storage, combo: 'region-east' },
    { id: 'mgmt-spine-north', data: { label: '管理核心Spine\n192.2.0.1' }, badgeColor: NODE_COLOR.spine, combo: 'region-north' },
    { id: 'biz-spine-north', data: { label: '业务核心Spine\n192.2.0.2' }, badgeColor: NODE_COLOR.storage, combo: 'region-north' },
    { id: 'mgmt-tor-north', data: { label: '管理TOR\n192.2.0.11' }, badgeColor: NODE_COLOR.tor, combo: 'region-north' },
    { id: 'biz-tor-north', data: { label: '业务TOR\n192.2.0.12' }, badgeColor: NODE_COLOR.tor, combo: 'region-north' },
    { id: 'storage-tor-north', data: { label: '存储TOR\n192.2.0.13' }, badgeColor: NODE_COLOR.tor, combo: 'region-north' },
    { id: 'mgmt-nodes-north', data: { label: '管理节点\nx3' }, badgeColor: NODE_COLOR.mgmt, combo: 'region-north' },
    { id: 'network-nodes-north', data: { label: '网络节点\nx2' }, badgeColor: NODE_COLOR.network, combo: 'region-north' },
    { id: 'compute-nodes-north', data: { label: '计算节点\nx2' }, badgeColor: NODE_COLOR.compute, combo: 'region-north' },
    { id: 'storage-nodes-north', data: { label: '存储节点\nx2' }, badgeColor: NODE_COLOR.storage, combo: 'region-north' },
  ],
  combos: [
