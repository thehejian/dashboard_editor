<template>
  <div class="create-page">
    <div class="create-header">
      ...
      <span class="create-title">新建自愈策略模板</span>
    </div>
      ...
      <div class="tmpl-section">
        ...
        <div v-for="(group, gi) in form.conditionGroups" :key="gi" class="tmpl-condition-group">
          ...
          <div v-for="(cond, ci) in group" :key="ci" class="tmpl-condition-row">
            ...
            <a-select v-model:value="cond.op" style="width:70px">
            ...
            <a-select v-model:value="cond.unit" style="width:70px">
              <a-select-option value="%">%</a-select-option>
          ...
          <div v-for="(step, si) in form.steps" :key="si" class="tmpl-step-item">
            ...
            <div class="tmpl-step-body">
              ...
              <div class="tmpl-step-flow">
                ...
                <a-select v-model:value="step.onSuccess" style="width:120px">
                ...
                <a-select v-model:value="step.onFailure" style="width:140px">
    ...
    <div class="create-footer">
      ...
      <a-button @click="handleSave('draft')">保存草稿</a-button>
      <a-button type="primary" @click="handleSave('active')">保存启用</a-button>
    </div>
  </div>
</template>
...
function goBack() {
  router.push('/ops/incidents/config/templates')
}
...
function handleSave(status) {
  ...
  message.success('模板「' + form.name + '」已保存' + (status === 'active' ? '并启用' : '草稿'))
  goBack()
}
</script>
