<template>
  <div>
    <div class="breadcrumb"><span>异常事件管理</span> / <span>检测规则</span> / <span>规则管理</span></div>
    <div class="filter-bar">
      ...
      <div style="flex:1;text-align:right"><a-button type="primary" @click="createModalOpen = true">+ 新建规则</a-button></div>
    </div>
