...
const historyData = ref([
  { id: 101, level: 'critical', title: '网络延迟过高', resource: 'lb-001', time: '2026-06-15 08:30', duration: '15分钟', status: 'resolved' },
  { id: 102, level: 'warning', title: '数据库连接池满', resource: 'db-002', time: '2026-06-14 14:20', duration: '30分钟', status: 'resolved' },
  { id: 103, level: 'info', title: '证书即将过期', resource: 'ingress-001', time: '2026-06-13 10:00', duration: '2天', status: 'resolved' },
  { id: 104, level: 'critical', title: '服务不可用', resource: 'payment-svc', time: '2026-06-12 16:45', duration: '45分钟', status: 'resolved' },
])
