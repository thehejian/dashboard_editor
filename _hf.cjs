...
(async () => {
  ...
  console.log('hover vs base (should be 0):', diff(base, during))
  console.log('tip visible during hover:', await page.locator('.mt-tip').isVisible().catch(() => false))

  await page.mouse.move(box.x + 420, box.y + 213)
  await page.waitForTimeout(800)
  const after = await snap()
  console.log('after leave vs base (should be 0):', diff(base, after))
  console.log('tip visible after leave:', await page.locator('.mt-tip').isVisible().catch(() => false))
